...
pip install -U Pandas Numpy SciPy scikit-learn
...
使用sklearn数据集必须先导入datasets模块
`from sklearn import datasets`

sklearn中的数据集：
![小数据集](https://images2017.cnblogs.com/blog/1251096/201710/1251096-20171029151405930-1982232117.png)
![大数据集](https://images2017.cnblogs.com/blog/1251096/201710/1251096-20171029151424867-594200677.png)

```python
iris = datasets.load_iris() # 导入选择的数据集，这里用鸢(yuān)尾花的数据集做分析
X = iris.data # 获取其特征向量
Y = iris.target # 获得样本label
```

### 1.2 创建数据集
*** 除了可以使用sklearn自带的数据集，还可以自己去创建训练样本，具体用法参见[《Dataset loading utilities》](http://scikit-learn.org/stable/datasets/) ***
...
"""
```
![](https://images2017.cnblogs.com/blog/1251096/201711/1251096-20171109204355747-768585630.png)
...
### 5.2 检验曲线
> 使用检验曲线，我们可以更加方便的改变模型参数，获取模型表现。[官网例子](http://scikit-learn.org/stable/auto_examples/model_selection/plot_validation_curve.html#sphx-glr-auto-examples-model-selection-plot-validation-curve-py)
```python
